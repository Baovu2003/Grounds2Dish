...
const HomePage = ({ productSeller = [] }) => {
  ...
  const sampleProducts = [
    {
      ProductId: 1,
      ProductName: "Bộ Bát Đĩa Sinh Học Premium",
      Price: 450000,
      ProductImages: [
        { ImageUrl: "https://images.unsplash.com/photo-1556909114-f6e7ad7d3136?w=500&h=500&fit=crop&crop=center" }
      ],
      Description: "Bộ bát đĩa được làm từ bã cà phê và nhựa sinh học, an toàn cho sức khỏe và thân thiện môi trường",
      Rating: 4.9,
      Sold: 1250,
      Badge: "BESTSELLER"
    },
    {
      ProductId: 2,
      ProductName: "Thìa Muỗng Eco-Friendly Set",
      Price: 180000,
      ProductImages: [
        { ImageUrl: "https://images.unsplash.com/photo-1583394838336-acd977736f90?w=500&h=500&fit=crop&crop=center" }
      ],
      Description: "Bộ thìa muỗng sinh học từ bã cà phê, chống nhiệt và bền đẹp",
      Rating: 4.8,
      Sold: 890,
      Badge: "HOT"
    },
    {
      ProductId: 3,
      ProductName: "Ly Cà Phê Tái Chế Signature",
      Price: 320000,
      ProductImages: [
        { ImageUrl: "https://images.unsplash.com/photo-1514228742587-6b1558fcf93a?w=500&h=500&fit=crop&crop=center" }
      ],
      Description: "Ly cà phê cao cấp từ bã cà phê tái chế, giữ nhiệt tốt và thiết kế sang trọng",
      Rating: 4.9,
      Sold: 2100,
      Badge: "NEW"
    },
    {
      ProductId: 4,
      ProductName: "Hộp Đựng Thức Ăn Biodegradable",
      Price: 280000,
      ProductImages: [
        { ImageUrl: "https://images.unsplash.com/photo-1556909114-f6e7ad7d3136?w=500&h=500&fit=crop&crop=center" }
      ],
      Description: "Hộp đựng thức ăn phân hủy sinh học, an toàn và tiện lợi cho cuộc sống hiện đại",
      Rating: 4.7,
      Sold: 1560,
      Badge: "ECO"
    }
  ...
  const displayProducts = productSeller.length > 0 ? productSeller : sampleProducts;
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            {displayProducts.map((product, index) => (
              <div
                ...
                className="group card hover:shadow-large transition-all duration-500 transform hover:-translate-y-2 animate-fade-in"
              ...
              >
                <div className="relative overflow-hidden rounded-xl mb-4">
                  ...
                  <div className="absolute top-4 right-4">
                    <span className={`px-3 py-1 rounded-full text-xs font-semibold text-white shadow-medium ${product.Badge === 'BESTSELLER' ? 'bg-gradient-to-r from-accent-warm to-accent-warning' :
                      product.Badge === 'HOT' ? 'bg-gradient-to-r from-accent-error to-red-500' :
                        product.Badge === 'NEW' ? 'bg-gradient-to-r from-accent-success to-green-500' :
                ...
                <div className="space-y-4">
                  <div>
                    <Link
                      ...
                      className="block font-semibold text-lg text-neutral-800 hover:text-primary-600 transition-colors duration-300 mb-2 line-clamp-2 group-hover:underline"
                    >
                      {product.ProductName}
                    </Link>
                    ...
                    <div className="flex items-center gap-1">
                      <div className="flex items-center">
                        {[...Array(5)].map((_, i) => (
                          <svg
                            key={i}
                            className={`w-4 h-4 ${i < Math.floor(product.Rating) ? 'text-accent-warning' : 'text-neutral-300'}`}
                            fill="currentColor"
                            viewBox="0 0 20 20"
                          >
                      ...
                      <span className="text-neutral-600 ml-1">({product.Rating})</span>
                    </div>
                    <span className="text-neutral-500">Đã bán {product.Sold}</span>
                  </div>
